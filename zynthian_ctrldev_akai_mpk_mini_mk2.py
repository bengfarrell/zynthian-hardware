...
# --------------------------------------------------------------------------
# 'Akai MPK mini mk2' device controller class
# --------------------------------------------------------------------------
class zynthian_ctrldev_akai_mpk_mini_mk2(zynthian_ctrldev_zynmixer):

    dev_ids = ["MPKmini2 IN 1"]
...
class MixerHandler(ModeHandlerBase):
    ...
    CC_PAD_START_A = 20 #8
    CC_PAD_VOLUME_A = 20 #8
    CC_PAD_PAN_A = 21 #9
    CC_PAD_MUTE_A = 22 #10
    CC_PAD_SOLO_A = 23 # 11
    CC_PAD_PANIC_STOP_A = 24 #12
    CC_PAD_AUDIO_RECORD = 25 #13
    CC_PAD_AUDIO_STOP = 26 #14
    CC_PAD_AUDIO_PLAY = 27 #15
    CC_PAD_END_A = 27 #15

    CC_PAD_START_B = 28 #16
    CC_PAD_VOLUME_B = 28 #16
    CC_PAD_PAN_B = 29 #17
    CC_PAD_MUTE_B = 30 #18
    CC_PAD_SOLO_B = 31 #19
    CC_PAD_PANIC_STOP_B = 32 #20
    CC_PAD_MIDI_RECORD = 33 #21
    CC_PAD_MIDI_STOP = 34 #22
    CC_PAD_MIDI_PLAY = 35 #23
    CC_PAD_END_B = 35 #23
...
class DeviceHandler(ModeHandlerBase):
    ...
    CC_PAD_DOWN = 21 #9
    CC_PAD_RIGHT = 22 #10
    CC_PAD_CTRL_PRESET = 23 #11
    CC_PAD_BACK_NO = 24 #12
    CC_PAD_UP = 25 #13
    CC_PAD_SEL_YES = 26 #14
    CC_PAD_OPT_ADMIN = 27 #15

    CC_PAD_KNOB1_BTN = 28 #16
    CC_PAD_KNOB2_BTN = 29 #17
    CC_PAD_KNOB3_BTN = 30 #18
    CC_PAD_KNOB4_BTN = 31 #19
    CC_PAD_PANIC_STOP = 32 #20
    CC_PAD_RECORD = 33 #21
    CC_PAD_STOP = 34 #22
    CC_PAD_PLAY = 35 #23
    CC_PAD_END = 35 #23

    PC_PAD_KNOB1_BTN = 20 #8
    PC_PAD_KNOB2_BTN = 21 #9
    PC_PAD_KNOB3_BTN = 22 #10
    PC_PAD_KNOB4_BTN = 23 #11

    CC_KNOB_START = 1 #24
    CC_KNOB_LAYER = 1 #24
    CC_KNOB_SNAPSHOT = 2 #25
    CC_KNOB_TEMPO = 3 #26
    CC_KNOB_BACK = 5 #28
    CC_KNOB_SELECT = 6 #29
    CC_KNOB_END = 8 #31
...
class PatternHandler(ModeHandlerBase):
    ...
    CC_KNOB_START = 1 #24
    CC_KNOB_MOVE_V = 2 #25  # K2
    CC_KNOB_STUTTER_COUNT = 3 #26  # K3
    CC_KNOB_STUTTER_DURATION = 4 #27  # K4
    CC_KNOB_MOVE_H = 6 #29  # K6
    CC_KNOB_DURATION = 7 #30  # K7
    CC_KNOB_VELOCITY = 8 #31  # K8
    CC_KNOB_END = 8 #31

    CC_PAD_START = 20 #8
    CC_PAD_PREV_PATTERN_A = 21 #9   # PAD 1 A
    CC_PAD_NEXT_PATTERN_A = 25 #13  # PAD 2 A
    CC_PAD_SHIFT_A = 29 #17  # PAD 3 A
    CC_PAD_ACTION_A = 23 #21  # PAD 4 A
    CC_PAD_PANIC_STOP_A = 20 #8   # PAD 5 A
    CC_PAD_RECORD_A = 24 #12  # PAD 6 A
    CC_PAD_STOP_A = 28 #16  # PAD 7 A
    CC_PAD_PLAY_A = 32 #20  # PAD 8 A
    CC_PAD_PREV_PATTERN_B = 23 #11  # PAD 1 B
    CC_PAD_NEXT_PATTERN_B = 27 #15  # PAD 2 B
    CC_PAD_SHIFT_B = 31 #19  # PAD 3 B
    CC_PAD_ACTION_B = 35 #23  # PAD 4 B
    CC_PAD_PANIC_STOP_B = 22 #10  # PAD 5 B
    CC_PAD_RECORD_B = 26 #14  # PAD 6 B
    CC_PAD_STOP_B = 30 #18  # PAD 7 B
    CC_PAD_PLAY_B = 34 #22  # PAD 8 B
    CC_PAD_END = 35 #23
...
class NotePadHandler(ModeHandlerBase):
    ...
    CC_KNOB_START = 1 #24
    CC_KNOB_ADJUST_NOTE = 7 #30
    CC_KNOB_REMOVE_NOTE = 8 #31
    CC_KNOB_END = 8 #31
...
class ConfigHandler(ModeHandlerBase):
    ...
    CC_PAD_START = 20 #8
    CC_PAD_SHIFT = 22 #10
    CC_PAD_ARP_TOGGLE = 23 #11
    CC_PAD_END = 35 #23

    CC_KNOB_START = 1 #24
    CC_KNOB_TEMPO_TAPS = 1 #24
    CC_KNOB_SWING = 2 #25
    CC_KNOB_AFTERTOUCH = 3 #26
    CC_KNOB_KEYBED_OCTAVE = 4 #27
    CC_KNOB_EXT_CLOCK = 6 #29
    CC_KNOB_PAD_CHANNEL = 7 #30
    CC_KNOB_KEYBED_CHANNEL = 8 #31
    CC_KNOB_END = 8 #31
